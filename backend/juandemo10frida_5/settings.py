"""
Django settings for juandemo10frida_5 project.
...
ROOT_URLCONF = 'juandemo10frida_5.urls'
...
WSGI_APPLICATION = 'juandemo10frida_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juandemo10frida_5 API",
    "DESCRIPTION": "API documentation for juandemo10frida_5 App",
    "VERSION": "v1",
}
